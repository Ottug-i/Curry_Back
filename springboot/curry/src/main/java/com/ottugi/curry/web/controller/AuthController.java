...
public class AuthController {
    ...
    public ResponseEntity<TokenResponseDto> singUpOrLogin(@RequestBody UserSaveRequestDto userSaveRequestDto, HttpServletResponse response) {
        return ResponseEntity.ok().body(authService.singUpOrLogin(userSaveRequestDto, response));
    }
