...
public class AuthController {
    ...
    public ResponseEntity<TokenResponseDto> singUpOrLogin(@RequestBody @Valid UserSaveRequestDto userSaveRequestDto,
                                                          HttpServletResponse response) {
        return ResponseEntity.ok().body(authService.signInOrSignUpAndIssueToken(userSaveRequestDto, response));
    }
