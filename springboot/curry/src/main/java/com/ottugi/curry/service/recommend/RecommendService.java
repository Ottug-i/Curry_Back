...
public interface RecommendService {
    ...
    Page<RecipeIngListResponseDto> findRecipePageByIngredientsDetection(RecipeIngRequestDto requestDto);
    ...
    @Transactional(readOnly = true)
    List<RecipeListResponseDto> findBookmarkOrRatingRecommendList(RecommendRequestDto requestDto);
}
